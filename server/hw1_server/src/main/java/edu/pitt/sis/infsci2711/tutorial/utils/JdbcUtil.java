...
public class JdbcUtil {
	...
	public static final String DEFAULT_USER = "yuyu"; //CHANGE TO YOUR MYSQL USER NAME
	
	public static final String DEFAULT_PASSWOD = "yu"; // CHANGE TO YOUR MYSQL PASSWORD
